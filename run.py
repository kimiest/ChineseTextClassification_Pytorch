...
from models.rcnn import MyModel   # 模型
from utils.data_loader import get_train_dev_DataLoader   # 数据集
...
'''获取DataLoader类型的训练数据'''
train_dl, valid_dl = get_train_dev_DataLoader(Config)

'''训练它10个epoch，保存最佳模型权重，查看最佳：1.验证损失 2.验证准确率'''
model.to(device)
